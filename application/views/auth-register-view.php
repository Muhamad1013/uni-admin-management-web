            ...
            <div class="card-body">
              ...
              <form method="post" action="<?php echo site_url('auth/register_process'); ?>">
                <div class="mb-3">
                  ...
                  <?= form_error('username', '<small class="text-danger">', '</small>'); ?> <!-- Display error if any -->
                </div>
                ...
                <div class="mb-3">
                  ...
                  <?= form_error('email', '<small class="text-danger">', '</small>'); ?> <!-- Display error if any -->
                </div>
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <?= form_error('password', '<small class="text-danger">', '</small>'); ?> <!-- Display error if any -->
                </div>
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="password" id="confirm_password" class="form-control" name="confirm_password"
                      placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" required />
                    <span class="input-group-text cursor-pointer" onclick="togglePasswordVisibility('confirm_password')">
                      <i class="bx bx-hide"></i>
                    </span>
                  </div>
                  <?= form_error('confirm_password', '<small class="text-danger">', '</small>'); ?> <!-- Display error if any -->
                </div>
              
                <div class="mb-3">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="terms-conditions" name="terms" value="1"
                      <?= set_checkbox('terms', '1'); ?> required />
                    <label class="form-check-label" for="terms-conditions">
                      I agree to <a href="javascript:void(0);">privacy policy & terms</a>
                    </label>
                  </div>
                  <?= form_error('terms', '<small class="text-danger">', '</small>'); ?> <!-- Display error if not checked -->
                </div>
              
                <!-- Submit button should be inside the form -->
                <button class="btn btn-primary d-grid w-100 mb-3" type="submit">Register</button>
              </form>
