        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">We have sent a 6-digit OTP to your email. Please enter it below.</p>

              <form method="post" action="<?php echo site_url('auth/verify_otp_process'); ?>">
                <div class="mb-3">
                  ...
                  <small class="form-text text-muted">Please enter the 6-digit OTP sent to your email.</small>
                </div>    
                <div class="mb-3">
                ...
                <div class="text-center">
                  ...
                  <a href="<?php echo site_url('auth/resend_otp'); ?>">Resend OTP</a>
                </div>
              </form>
            </div>
          </div>
