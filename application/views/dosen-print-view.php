  ...
  <table>
    ...
    <tbody>
      <?php foreach ($dosen as $index => $row): ?>
        <tr>
          <td><?= $index + 1; ?></td>
          <td><?= htmlspecialchars($row->nama_dosen); ?></td> <!-- Menggunakan nama_dosen -->
          <td><?= htmlspecialchars($row->nip); ?></td> <!-- Menggunakan nip -->
          <td><?= htmlspecialchars($row->email); ?></td> <!-- Menggunakan email -->
          <td><?= htmlspecialchars($row->telepon); ?></td> <!-- Menggunakan telepon -->
          <td><?= htmlspecialchars($row->alamat); ?></td> <!-- Menggunakan alamat -->
          <td><?= htmlspecialchars($row->jurusan); ?></td> <!-- Menggunakan jurusan -->
        </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
